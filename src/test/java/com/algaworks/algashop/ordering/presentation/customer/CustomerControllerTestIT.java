...
class CustomerControllerTestIT extends AbstractPresentationIT {
    ...
    private static final UUID invalidCustomerId = UUID.fromString("a7f4c8b9-2d35-4871-9e3c-4b62f1a9d7f5");
    ...
    public void shouldCreateCustomer() {
        String json = AlgaShopResourceUtils.readContent("json/customer/create-customer.json");
        ...
        assertThat(customerRepository.existsById(createdCustomerId)).isTrue();
    }
    ...
    public void shouldArchiveCustomer() {
        ...
        assertThat(customerRepository.existsById(validCustomerId)).isTrue();
        assertThat(customerRepository.findById(validCustomerId).orElseThrow().getArchived()).isTrue();
    }
