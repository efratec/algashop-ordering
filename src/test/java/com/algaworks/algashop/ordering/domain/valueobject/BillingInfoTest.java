...
class BillingInfoTest {
    ...
    void givenValidData_whenCreate_thenShouldCreateShippingInfo() {
        ...
        var billingInfoExpected = BillingInfo.of(fullName, document, phone, address);

        assertEquals(fullName, billingInfoExpected.fullName());
        assertEquals(document, billingInfoExpected.document());
        assertEquals(phone, billingInfoExpected.phone());
        assertEquals(address, billingInfoExpected.address());
    }
