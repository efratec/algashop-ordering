...
public class ShoppingCartBase {
    ...
    private static final UUID notFoundShoppingCartId = UUID.fromString("e2103964-5353-4910-81ee-212a40a2ca70");
    ...
    void setUp() {
        ...
        Mockito.when(queryService.findById(validShoppingCartId))
                .thenReturn(ShoppingCartOutputTestFixture.aShoppingCart().id(validShoppingCartId).build());
