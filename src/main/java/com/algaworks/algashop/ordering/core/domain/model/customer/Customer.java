...
import static com.algaworks.algashop.ordering.core.domain.exception.ErrorMessages.VALIDATION_ERROR_FULLNAME_IS_NULL;
...
public class Customer extends AbstractEventSourceEntity implements AggregateRoot<CustomerId> {
    ...
    public void archive() {
        ...
        this.setFullName(FullName.of("Anonymous", "Anonymous"));
        this.setPhone(Phone.of("000-000-0000"));
        this.setDocument(Document.of("000-00-0000"));
        this.setEmail(Email.of(UUID.randomUUID() + "@anonymous.com"));
    ...
    private void verifyIfChangeable() {
        if (Boolean.TRUE.equals(this.isArchived())) {
            throw CustomerArchivedException.becauseCustomerIsArchived();
        }
    }
