...
public class ShoppingCartUpdateProvider implements ShoppingCartProductAdjustmentService {
    ...
    @Override
    @Transactional
    public void changeAvailability(ProductId productId, boolean availability) {
        shoppingCartPersistenceEntityRepository.updateItemAvailability(productId.value(), availability);
    }
