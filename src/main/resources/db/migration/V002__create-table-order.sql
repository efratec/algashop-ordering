...
create index idx_order_customer_id on public.tb_order (customer_id);
alter table public.tb_order add constraint fk_order_customer_id foreign key (customer_id) references public.tb_customer(id);
...
create index idx_order_item_order_id on public.tb_order_item (order_id);
alter table public.tb_order_item add constraint fk_order_item_order_id foreign key (order_id) references public.tb_order(id);
